...
document.addEventListener('DOMContentLoaded', function() {
    ...
    addMenu.addEventListener("click", function() {
      ...
      document.getElementById("save").addEventListener("click", function() {
        ...
        updateMenuList(command, id, name, price, desc, path);
        modal.style.display = "none";  
      });
    });
    ...
    function updateMenuList(command, id, name, price, desc, path) {
      var xhr = new XMLHttpRequest();
      var url = "/api/addMenu.php";
      var params = "command=" + encodeURIComponent(command) + "&id=" + encodeURIComponent(id) + "&name=" + encodeURIComponent(name) + "&price=" + encodeURIComponent(price) + "&desc=" + encodeURIComponent(desc) + "&path=" + encodeURIComponent(path);
